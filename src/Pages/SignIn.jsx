    ...
    <div className='flex justify-center w-full h-full'>
      ...
      <div className='h-FULL w-1/2 p-8 flex justify-center '>
        <div className='w-full max-w-md '>
          <h2 className='text-2xl font-semibold text-center mb-6 text-[#020B56]'>
            Connectez-vous à votre compte
          </h2>
          <h4 className='text-xl font-regular text-[#020B56] text-center mb-20'>
          ...
          <form onSubmit={handleSubmit}>
            <div className='mb-4 flex-column'>
              <div className='flex-1'>
                <label
                  htmlFor='email'
                  className='block text-[#020B56] mb-2 font-semibold'
                >
                  Email<span className='text-[#E31A1A]'> *</span>
                </label>
              </div>
              <div>
                <input
            ...
            <div className='mb-20 flex-column'>
              <div className='flex-1'>
                <label
                  htmlFor='password'
                  className='block text-gray-700 mb-2 text-[#020B56] font-semibold'
                >
                  Mot De Passe <span className='text-[#E31A1A]'> *</span>
                </label>
              </div>
              <div>
                <input
            ...
            <h6 className='text-1xl font-regular text-gray text-center '>
              Vous n'avez pas encore de compte ?
            </h6>
            <h6 className='text-1xl font-regular text-[#020B56] text-center mb-6 hover:underline'>
              Créer un compte ici
            </h6>
