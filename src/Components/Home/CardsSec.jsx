...
//       try {
//         const response = await fetch('https://your-backend-url/api/cards'); // Replace with your backend URL
//         if (!response.ok) {
//           throw new Error('Failed to fetch cards');
//         }
//         const data = await response.json();
//         setCards(data); // Assuming the API returns an array of cards
//         setLoading(false);
//       } catch (err) {
...
//       <div className="relative bg-[#EAF6FF]">
//         {/* Show loading state */}
//         {loading && <p className="text-center text-[#020B58]">Loading...</p>}
//         {/* Show error if any */}
